...
function Contact() {
  return (
   ...
   <motion.div 
     ...
     <h1 className='font-serif text-grey text-2xl pt-20 pl-36 lg:pt-36 md:pl-72 lg:pl-36 '>Contact</h1>
     <h2 className='text-lg font-serif leading-8 text-grey pl-28 md:pl-64 lg:pl-36  '>Phone: 97466 96969 <br /> Instagram: techido.in</h2>
   </motion.div>
   <motion.div 
         variants={fadeIn("right", 0.5)}
         initial="hidden"
